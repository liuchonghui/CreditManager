...
public class HttpsUtils
{
    ...
    {
        InputStream [] certificates = new InputStream []{EngineManager.getInstance().getContext().
                getResources().openRawResource(EngineManager.getInstance().getEngineConfig().getCerResourceId())};
        return HttpsUtils.getSslSocketFactory(certificates, null, null);
    }
