...
public class PinnedSectionListView extends ListView {
    ...
    boolean sectionItemVisible = true;
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (isFirstVisibleItemSection) {
                ...
                if (sectionView.getTop() == getPaddingTop()) { // view sticks to the top, no need for pinned shadow
                    ...
                    if (!sectionItemVisible) {
                    	if (sectionView.getTop() < getPaddingTop() && sectionView.getVisibility() == View.VISIBLE) {
                    		sectionView.setVisibility(View.INVISIBLE);
                    		sectionView.setTag(R.id.tag_changed_visibility, true);
                    	}
                    }
                }
    ...
    public void setSectionItemVisible(boolean visible) {
    	sectionItemVisible = visible;
    }
