...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	public void setOnScrollChangedListener(OnScrollChangedListener l) {
		if (getRefreshableView() instanceof InternalWebViewSDK9) {
			InternalWebViewSDK9 webView = (InternalWebViewSDK9) getRefreshableView();
			webView.setOnScrollChangedListener(l);
		}
	}
	...
	protected boolean isReadyForPullEnd() {
		...
		// shaozhe-kang modified at 2014.10.14
		int offset = 0;
		if(Build.VERSION.SDK_INT >= 19){
			offset = 10;
		}
		// shaozhe-kang modified at 2014.10.14
		return (mRefreshableView.getScrollY() + offset) >= (exactContentHeight - mRefreshableView.getHeight());
	}
